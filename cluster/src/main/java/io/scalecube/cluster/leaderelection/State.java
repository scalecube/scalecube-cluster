...
public enum State {
   ...
   * some time period, the follower will transition to the candidate state. During this period, the
   ...
   * than one leader can exist at any given time, but Raft guarantees that no two leaders will exist
   * for the same {@link Cluster#term()}.
   */
  LEADER
}
